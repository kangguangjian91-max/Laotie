...
export async function generateMetadata({ params }: ProductPageProps): Promise<Metadata> {
  ...
  return {
    ...
    description: product.description,
      ...
      url: `https://laotie-steel.com/products/${slug}`,
      type: "article",
    },
    twitter: {
...
export default async function ProductDetailPage({ params }: ProductPageProps) {
  ...
  const productSchema = {
    ...
    name: product.title,
    description: product.description,
    image: `https://laotie-steel.com${product.image}`,
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 3, name: product.title, item: `https://laotie-steel.com/products/${slug}` },
    ],
  };
