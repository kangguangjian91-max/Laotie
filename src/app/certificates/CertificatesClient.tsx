        ...
        <div className="grid md:grid-cols-2 gap-8">
          {certificates.map((cert, index) => (
            ...
            >
              ...
              <div 
                className="mt-4 bg-gray-50 rounded-lg overflow-hidden border border-gray-200 relative min-h-[200px] cursor-pointer hover:opacity-90 transition-opacity"
              ...
              >
                ...
                <div className="absolute inset-0 flex items-center justify-center opacity-0 hover:opacity-100 transition-opacity bg-black/20">
                  <span className="text-white text-sm font-semibold bg-black/50 px-3 py-1 rounded-md">
                    Click to enlarge
                  </span>
                </div>
              </div>
