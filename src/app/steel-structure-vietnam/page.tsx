...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      "Your trusted steel structure partner in Vietnam. 500+ projects completed across Hanoi, Ho Chi Minh City, Da Nang.",
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg mb-8 text-red-200 max-w-2xl mx-auto">
              500+ projects completed across Hanoi, Ho Chi Minh City, Da Nang & more.
