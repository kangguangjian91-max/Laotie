        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm">
              ...
              <li>
                <a 
                  href="/steel-structure-saudi-arabia" 
                  onClick={() => trackLandingPageView("Saudi Arabia", "saudi-arabia")}
                  className="hover:text-white transition-colors inline-flex items-center gap-1 group"
                >
                  <span className="w-0 group-hover:w-1 h-0.5 bg-steel-accent rounded-full transition-all" />
                  🇸🇦 Saudi Arabia
              ...
              <li>
                <a 
                  href="/steel-structure-australia" 
                  onClick={() => trackLandingPageView("australia", "australia")}
                  className="hover:text-white transition-colors inline-flex items-center gap-1 group"
                >
                  <span className="w-0 group-hover:w-1 h-0.5 bg-steel-accent rounded-full transition-all" />
                  🇦🇺 Australia
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm">
              <li className="flex items-center gap-2">
                ...
                <a 
                  href="https://www.google.com/maps/search/Henan+Laotie+Steel+Structure+Engineering+Co.+Ltd" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  onClick={() => trackOutboundLink("https://www.google.com/maps/search/Henan+Laotie+Steel+Structure+Engineering+Co.+Ltd", "other")} 
